...
class EditDetails extends StatefulWidget {
  int index;
  EditDetails({super.key, required this.index});
    ...
    return Scaffold(
      ...
      body: Consumer<DataProvider>(
        builder: (context, value, child) {
          Employee snap = value.users[widget.index];
          return Container(
